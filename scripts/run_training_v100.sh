...
DATA_ROOT="/home/ubuntu/azureblob/4D-Lung-Interpolated/data/"
...
if [ ! -f "$METADATA_CSV" ]; then
    ...
    echo "  python scripts/create_splits.py --data-root $DATA_ROOT --output-dir /home/ubuntu/azureblob/4D-Lung-Interpolated/splits/"
    exit 1
fi
